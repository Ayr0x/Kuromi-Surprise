...
export default function App() {
  ...
  // Lógica de Autoplay y Volumen inicial
  useEffect(() => {
    if (audioRef.current) {
      audioRef.current.volume = volume;
      // Intenta reproducir automáticamente (algunos navegadores bloquean esto hasta que el usuario hace clic)
  ...
  return (
    <>
      {/* 
        Elemento de audio HTML oculto. 
        Al estar fuera de la condición "showCards", la música nunca se detiene.
      */}
      <audio ref={audioRef} src={backgroundMusic} loop />

      {/* Reproductor de música flotante (siempre visible en la esquina superior derecha) */}
